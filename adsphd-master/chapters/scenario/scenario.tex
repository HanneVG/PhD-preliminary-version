...
\begin{figure}[tbhp]
	\centering
		\includegraphics[width=12cm]{ScenClim_600dpi.png}
...
\begin{figure}[tbhp]
	\centering
		\includegraphics[width=12cm]{ScenMekelle_600dpi.png}
...
\begin{figure}[tbhp]
	\centering
		\includegraphics[width=8cm]{Failure_600dpi.png}
